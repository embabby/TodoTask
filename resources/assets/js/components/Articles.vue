<template>
	<div>
		...
		<div class="card card-body mb-2" v-for="article in articles" v-bind:key="article.id">
			...
			<button @click="deleteArticle(article.id)" class="btn btn-danger">Deleteeeee</button>
	...
	export default {
		...
		data() {
			return {
				...
				article_id: '',
				pagination: {},
				edit: false // cause we will use this form for add and edit
			}
		},
